...
var _planets = __webpack_require__(32);

var _planets2 = _interopRequireDefault(_planets);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_planets2.default, null), document.getElementById('app'));
...
var _planetsInfo = __webpack_require__(40);

var _planetsInfo2 = _interopRequireDefault(_planetsInfo);
...
var App = function (_Component) {
	...
	_createClass(App, [{
		...
		value: function componentDidMount() {
			...
			axios.get('https://swapi.co/api/planets/').then(function (_ref) {
				var data = _ref.data;
		...
		value: function render() {
			var tweetL = this.state.tweet.map(function (el, index) {
